...
def analyze_single_run(run_id: str, csv_name: str = "prototype.csv"):
    ...
    output_dir = os.path.join(r"C:\Users\Anna\Documents\UM\Project 2-1\ml-agents-develop\ml-agents-develop\results", run_id)
    ...
    axes[0, 1].plot(X_length, y_length_pred, color='red', linewidth=2, label=f'Linear Fit (R²={r2_score(y_length, y_length_pred):.3f})')
